...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post readings_url, params: { reading: { alkalinity: @reading.alkalinity, chlorine: @reading.chlorine, datetime: @reading.datetime, ph: @reading.ph, pool_id: @reading.pool_id, stabilizer: @reading.stabilizer } }
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { alkalinity: @reading.alkalinity, chlorine: @reading.chlorine, datetime: @reading.datetime, ph: @reading.ph, pool_id: @reading.pool_id, stabilizer: @reading.stabilizer } }
