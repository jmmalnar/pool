...
class ReadingsTest < ApplicationSystemTestCase
  ...
  test "creating a Reading" do
    ...
    fill_in "Alkalinity", with: @reading.alkalinity
    fill_in "Chlorine", with: @reading.chlorine
    fill_in "Datetime", with: @reading.datetime
    fill_in "Ph", with: @reading.ph
    fill_in "Pool", with: @reading.pool_id
    fill_in "Stabilizer", with: @reading.stabilizer
